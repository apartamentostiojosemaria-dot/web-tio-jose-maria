...
| 6 | `numHabitaciones` a fuego en 1 | 🟨 `apartments.num_habitaciones` con el valor de cada uno (Albahaca 1, Tomillo 1, Lavanda 2, Romero 2). Falta desplegar. ✅ **CONFIRMADO por el titular el 10-sep-2026**: Lavanda y Romero tienen **2 dormitorios** cada uno. La deducción de `bed_config` era correcta; ya no es una suposición | `0010` |
