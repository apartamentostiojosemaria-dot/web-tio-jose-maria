    ...
    return (
        <div className="bg-surface" style={{ fontFamily: '"Lato", sans-serif' }}>
            <PageHead
                ...
                description="Reserva en Apartamentos Rurales Tío José María. Alojamiento con encanto en Hinojares, Sierra de Cazorla. Historia, confort y chimenea en una casa del siglo XVIII."
                path="/"
            />
