    ...
    <div className="min-h-screen bg-white">
        ...
        <main className="pt-24 pb-20 px-6">
            <div className="max-w-4xl mx-auto prose prose-gray">
                <h1 className="font-serif text-3xl md:text-4xl font-bold mb-2" style={{ color: COLORS.text }}>
                    Política de Privacidad
                </h1>
                <p className="text-sm text-gray-400 mb-10">Última actualización: 28 de marzo de 2026</p>

                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>1. Responsable del tratamiento</h2>
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>2. Datos que recopilamos</h2>
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>3. Finalidad del tratamiento</h2>
                <ul className="text-gray-600 space-y-1 mb-4 list-disc pl-6">
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>4. Base legal</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>5. Conservación de datos</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>6. Destinatarios</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>7. Derechos del usuario</h2>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                    Para ejercer estos derechos, contacta con nosotros en <a href="mailto:info@tiojosemaria.com" className="underline" style={{ color: COLORS.primary }}>info@tiojosemaria.com</a>. También puedes presentar una reclamación ante la <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: COLORS.primary }}>Agencia Española de Protección de Datos</a>.
                </p>

                <h2 className="font-serif text-xl font-bold mt-8 mb-3" style={{ color: COLORS.text }}>8. Cookies</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
