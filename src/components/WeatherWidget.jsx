...
const WeatherWidget = ({ isMinimal = false }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm overflow-hidden relative group">
            <div className="flex justify-between items-start relative z-10">
                <div>
                    <span className="text-[10px] font-bold uppercase tracking-widest text-rural-400 mb-1 block">El tiempo en Hinojares</span>
                ...
                {weather.daily.time.slice(1, 4).map((time, i) => {
                    ...
                    return (
                        <div key={i} className="text-center">
                            ...
                            <span className="text-xs font-bold text-rural-900">{Math.round(weather.daily.temperature_2m_max[i + 1])}°</span>
                        </div>
                    );
                })}
            </div>
