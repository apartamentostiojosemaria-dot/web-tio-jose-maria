...
const SECTIONS = [
    ...
    { key: 'checkin_instructions',    label: 'Entrada y llaves',              icon: Home,     type: 'textarea', rows: 3,  hint: 'Hora de entrada, cómo se dan las llaves, qué hacer si llegan tarde. Lo ve el huésped ANTES de venir.' },
    { key: 'checkout_instructions',   label: 'Salida',                        icon: Home,     type: 'textarea', rows: 3,  hint: 'Hora de salida, dónde dejar las llaves, qué dejar recogido. Lo ve el huésped el día de irse.' },
